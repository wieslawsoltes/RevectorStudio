...
export class TesseractOcr {constructor(options?:{node?:boolean;languages?:string;moduleUrl?:string;workerPath?:string;corePath?:string;langPath?:string;provider?:{createWorker:Function};onProgress?:(p:any)=>void});recognize(image:any,options?:OcrOptions&{psm?:number}):Promise<any>;dispose():Promise<void>}
