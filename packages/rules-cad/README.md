...
**CAD-print recovery rules** — Revector Studio 0.2.0.
...
```js
import * as Revector from '@revector/rules-cad';
```

## Public API

cadRules, CAD_PROFILES, detectProducerProfile, VectorTemplateLibrary
